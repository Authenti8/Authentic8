...
import { dashboardOrigin, paymentOrigin } from "@/lib/feature-origins";
    ...
    <div className="dashboard-shell">
      <aside className="dashboard-sidebar">
        ...
        <nav aria-label="Workspace navigation"><small>Workspace</small>
          <DashboardNav canViewBilling={canViewBilling} dashboardOrigin={dashboardOrigin()}
            paymentOrigin={paymentOrigin()} /></nav>
