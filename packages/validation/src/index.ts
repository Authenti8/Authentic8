...
const eventTypes = new Set([
  ...
  "PROCESS_STARTED", "PROCESS_STOPPED", "KNOWN_PROCESS_MATCH",
  "WINDOW_CREATED", "WINDOW_CHANGED", "HIDDEN_OVERLAY_MATCH",
  "CAPTURE_EXCLUDED_WINDOW", "BROWSER_EXTENSION_MATCH", "BROWSER_EXTENSION_CHANGED",
  "BROWSER_PROFILE_HEALTH", "AUDIO_DEVICE_ADDED", "AUDIO_ROUTE_CHANGED",
  "AGENT_TAMPERED", "MONITORING_INTERRUPTED",
